...
export const Github_UserName = "KeshavTandon";

export const Github_API_User = "https://api.github.com/users/";

// Social Media Links
export const Linkedin_Link = "https://www.linkedin.com/in/tandonkeshav/";
export const Github_Link = "https://github.com/KeshavTandon";
export const Email_Link = "mailto:keshavtandon51@gmail.com";
